...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=hass-nexus-metro&category=integration)
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=nexus_metro)
...
Find all entities in **Settings** → **Devices & Services** → **Nexus Metro** → click on the device.
...
```yaml
service: nexus_metro.example_action
data:
  # Add your parameters here
```

### `nexus_metro.reload_data`
...
```yaml
service: nexus_metro.reload_data
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Nexus Metro → 3 dots → Download diagnostics)
