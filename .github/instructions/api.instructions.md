...
- `NexusMetroApiClientError` (Base)
- `NexusMetroApiClientCommunicationError` (Network, timeout, HTTP errors)
- `NexusMetroApiClientAuthenticationError` (401, 403, invalid credentials)
