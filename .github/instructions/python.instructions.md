...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `NexusMetro`
...
- Inherit from both platform entity and `NexusMetroEntity` (order matters)
...
from custom_components.nexus_metro.sensor import async_setup_entry
...
**Config entry data:** `entry_data: NexusMetroData = hass.data[DOMAIN][entry.entry_id]`
