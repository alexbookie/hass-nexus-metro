...
- **`entity/`** - Base entity classes (inherit `NexusMetroEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, NexusMetroEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import NexusMetroEntity`
