...
- `entity/` — Base entity class (`NexusMetroEntity`)
...
- Entity MRO: `(PlatformEntity, NexusMetroEntity)` — order matters
...
- Debug level: `custom_components.nexus_metro: debug` in `config/configuration.yaml`
