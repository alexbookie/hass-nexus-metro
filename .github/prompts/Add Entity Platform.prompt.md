...
**Directory:** `custom_components/nexus_metro/[platform]/`
...
```python
"""[Platform] platform for Nexus Metro."""
...
from .entity import NexusMetroEntity
from .[entity_file] import NexusMetro[EntityName]
from .const import DOMAIN
from .coordinator import NexusMetroDataUpdateCoordinator
...
async def async_setup_entry(
    ...
    coordinator: NexusMetroDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            NexusMetro[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Nexus Metro."""
...
class NexusMetro[EntityName](
    ...
    def __init__(
        self,
        coordinator: NexusMetroDataUpdateCoordinator,
        entry: ConfigEntry,
    ) -> None:
...
Add platform to `custom_components/nexus_metro/manifest.json`:
...
- [ ] Entity class inherits from both `NexusMetroEntity` and platform class
...
- **Base entity:** `NexusMetroEntity` in `entity/base.py`
- **Coordinator:** `NexusMetroDataUpdateCoordinator`
