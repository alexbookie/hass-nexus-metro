...
**File:** `custom_components/nexus_metro/services.yaml`
...
Create `custom_components/nexus_metro/service_actions/[action_name].py`:

```python
"""[Action name] service action for Nexus Metro."""
...
**File:** `custom_components/nexus_metro/__init__.py`
...
**File:** `custom_components/nexus_metro/const.py`
...
3. Find service action: `nexus_metro.[action_name]`
...
- **Domain:** `nexus_metro`
- **Service actions directory:** `custom_components/nexus_metro/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/nexus_metro/services.yaml` (legacy filename)
- **Icons:** `custom_components/nexus_metro/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/nexus_metro/translations/*.json` under `services` key (legacy)
