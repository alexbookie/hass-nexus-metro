...
- Inherit from `NexusMetroEntity` and platform base class
...
- Entity: `custom_components/nexus_metro/[platform]/[entity_name].py`
- Platform: `custom_components/nexus_metro/[platform]/__init__.py`
