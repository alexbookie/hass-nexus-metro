...
- Create new sensor file in `custom_components/nexus_metro/sensor/`
- Inherit from `NexusMetroEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Nexus Metro."""
...
class NexusMetro[SensorName]Sensor(
    NexusMetroEntity,
    SensorEntity,
):
...
- Entity: `custom_components/nexus_metro/sensor/[sensor_name].py`
- Platform: `custom_components/nexus_metro/sensor/__init__.py`
- Translations: `custom_components/nexus_metro/translations/*.json`
